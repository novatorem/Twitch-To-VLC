package com.novatorem.ttvlc.service;
...
import com.novatorem.ttvlc.activities.main.FeaturedStreamsActivity;
import com.novatorem.ttvlc.activities.main.MyChannelsActivity;
import com.novatorem.ttvlc.activities.main.MyGamesActivity;
import com.novatorem.ttvlc.activities.main.MyStreamsActivity;
import com.novatorem.ttvlc.activities.main.TopGamesActivity;
import com.novatorem.ttvlc.activities.main.TopStreamsActivity;
import com.novatorem.ttvlc.broadcasts_and_services.NotificationReceiver;
import com.novatorem.ttvlc.misc.TwitchWeb;
import com.novatorem.ttvlc.misc.SecretKeys;
...
public class Service {
    ...
    public static String getTwitchWebClientID() {
        return TwitchWeb.TWITCH_WEB_CLIENT_ID;
    }
    ...
    public static Intent getPlayStoreIntent() {
        ...
        intent.setData(Uri.parse("market://details?id=net.novac.ttvlc"));
        return intent;
    }
    ...
    public static String urlToJSONString(String urlToRead) {
        // Alright, so sometimes Twitch decides that Twitch To VLC's client ID should be blocked. Currently only happens for the hidden /api endpoints.
    ...
    public static String urlToJSONString(String urlToRead, Boolean useTwitchToVLCClientId) {
        if (!TwitchToVLCApplication.isCrawlerUpdate && urlToRead.contains("api.twitch")) {
            TwitchToVLCApplication.trackEvent(R.string.category_api, R.string.action_api_twitch, urlToRead);
        }

        String clientId;
        if (useTwitchToVLCClientId) {
