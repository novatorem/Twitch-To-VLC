...
package com.novatorem.ttvlc.billing;
...
public class IabHelper {
    ...
    public boolean consumeToken(String token, Activity activity) {
        try {
    ...
    public Bundle getDonationDetails(ArrayList<String> SKUs) throws RemoteException, JSONException {
        Log.d("HELPERDETAILS", "Starting to get donation details");

        Bundle querySkus = new Bundle();
        querySkus.putStringArrayList(GET_SKU_DETAILS_ITEM_LIST, SKUs);

        return mService.getSkuDetails(3, mContext.getPackageName(),
    ...
    public void purchase(Activity act, String sku, int requestCode, OnIabPurchaseFinishedListener listener)
        throws IabAsyncInProgressException {
        checkNotDisposed();
